...
namespace Core.CrossCuttingConcerns.Caching
{
    public class MemoryCacheManager : ICacheManager
    {
        ...
        public bool IsInclude(string key)
        {
            return _memoryCache.TryGetValue(key, out _);  //bu yeni öğrendiğim bir şey fonksiyon kodlanış itibariyle bize data verisini de vermek istiyor
                                                          //ancak biz istemiyoruz burda ' out _ ' kodu boş döndürmesini sağlıyor yani data vermeyecek bize.
